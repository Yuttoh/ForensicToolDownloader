...
void InitializeTools() {
    ...
    g_tools = {
        ...
        MakeTool(L"Velociraptor", L"Others",
                 L"https://github.com/Velocidex/velociraptor/releases/download/v0.76/velociraptor-v0.76.6-windows-amd64.exe",
                 L"Velociraptor.exe",
                 L"Velociraptor, uma ferramenta coletora de artefatos do Sistema Windows, MacOS e Linux", false),
        ...
        MakeTool(L"Volatility", L"Others",
        ...
        MakeTool(L"PathsParser", L"Spokwn",
                 L"https://github.com/spokwn/PathsParser/releases/download/v1.2/PathsParser.exe",
                 L"PathsParser.exe",
                 L"Parser para caminhos em textos.", false),
        ...
        MakeTool(L"WinDefLogView", L"Nirsoft",
                 L"https://www.nirsoft.net/utils/windeflogview.zip",
                 L"windeflogview.zip",
                 L"Visualizador NirSoft para historico do Windows Defender.", true),
